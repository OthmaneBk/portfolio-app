    ...
    <div className="projects-container" id="Projets">
        ...
        <div className="projects-grid">
            <div className="project">
                <a ><img src={mock10} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={mock09} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={mock08} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={mock07} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={mock06} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={mock05} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={mock04} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={Rec} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={PopularName} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={logs} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
            ...
            <div className="project">
                <a ><img src={Colle} className="zoom" alt="thumbnail" width="100%" height="70%"/></a>
